...
export const RegisterForm = () => {
  ...
  return (
    <form className="text-black flex flex-col gap-4">
      ...
      <button
        className="bg-accent text-white font-semibold uppercase rounded-md py-3 transition-all hover:bg-accent-hover disable:opacity-50 w-full cursor-pointer mt-4"
