...
export const Route = createFileRoute("/_app/our-stores/")({
  ...
  head: () => ({
    meta: [
      {
        title: "Nossas lojas - Syntax Wear",
      },
    ],
  }),
});
...
function RouteComponent() {
  return (
    <section className="container py-6">
      <img
        src={OurStoresBanner}
        alt="Banner interior da loja, com os tênis dispostos"
        className="rounded-[20px] h-80 md:h-125 object-cover w-full"
      />

      <div>
        <h1 className="text-black text-2xl max-w-7x1 m-auto my-20 text-center">
          Nossas lojas são o coração da nossa marca. Explore a coleção mais
          recente, experimente seus modelos favoritos e sinta o confort da
        ...
        <section className="text-black w-full space-y-20">
          ...
          <div className="flex flex-col md:flex-row items-center gap-2.5">
            <img
              src={OurStoresImg2}
              alt="Imagem de propaganda da loja"
              className="rounded-[20px] md:max-w-[42vw] aspect-10/7 object-cover size-full"
            />
